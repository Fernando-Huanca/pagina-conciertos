...
class LoginComponent extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement("h1", null, this.state.mode === 'login' ? 'Bienvenido!' : 'Registrarse'), /*#__PURE__*/
      React.createElement("div", { className: "form-block__toggle-block" }, /*#__PURE__*/
      React.createElement("span", null, this.state.mode === 'login' ? 'No tienes' : 'Ya tienes', " una cuenta? Haz click aquí \u2192"), /*#__PURE__*/
...
class LoginForm extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement(Input, { type: "email", id: "email", label: "Correo", disabled: this.props.mode === 'login' }), /*#__PURE__*/
      React.createElement(Input, { type: "password", id: "createpassword", label: "Contraseña", disabled: this.props.mode === 'login' }), /*#__PURE__*/
      React.createElement(Input, { type: "password", id: "repeatpassword", label: "Repita su contraseña", disabled: this.props.mode === 'login' }))), /*#__PURE__*/
